...
<%@ page import="com.sree.JobApp.model.*" %>
...
<nav class="navbar navbar-expand-lg navbar-light bg-clr">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">sree Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://sree.com/">Contact</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
<%  System.out.println("inside success.jsp page.............");
JobPost myjobPost = (JobPost) request.getAttribute("jobPost"); 
System.out.println("request attribute............."+myjobPost.getPostId());
%>
